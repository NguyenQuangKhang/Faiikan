...
//
      if (_scrollController.position.pixels ==
        ...
        context.read<ProductDetailBloc>().add(LoadMoreProductAlsoLikeEvent(person_id: widget.userId.toString()));
      }
    });
    //AppBar
                                                          ...
                                                          child: Center(
                                                            ...
                                                            NumberFormat
                                                                ...
                                                                .format((widget
                                                                        ...
                                                                        .priceMin *
                                                                    (1 +
                                                                        (productDetailBloc.productDetail.promotionPercent /
                                                                            100)))),
                                                            style: TextStyle(
                                                                fontSize: 12,
                                                                color: Colors
                                ...
                                return GestureDetector(
                                    child: ProductCard(
                                      ...
                                      width: MediaQuery.of(context)
                                          ...
                                          2,
                                      product:
                                      productDetailBloc.listProductAlsoLike[index],
                                      index: index,
                                    ),
                                    onTap: () {
                                      Navigator.push(
                                                  ...
                                                  MultiBlocProvider(
                                                      ...
                                                      ProductDetail(
                                                        userId: context
                                                            ...
                                                            .user
                                                            .id!,
                                                        percentStar: productDetailBloc.listProductAlsoLike[
                                                        index]
                                                            .percentStar,
                                                        countRating: productDetailBloc.listProductAlsoLike[
                                                        index]
                                                            .countRating,
                                                        price: productDetailBloc.listProductAlsoLike[
                                                        index]
                                                            .price,
                                                        productId:
                                                        productDetailBloc.listProductAlsoLike[
                                                        index]
                                                            .id,
                                                      ))));
                                    });
                              },
                              childCount: productDetailBloc.listProductAlsoLike.length,
                            ),
                          ),
                        ]),
                  ),
