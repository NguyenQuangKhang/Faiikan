...
import 'package:faiikan/FirebaseMethod/FirebaseMethod.dart';
...
class ConversationScreen extends StatefulWidget {
  ...
  const ConversationScreen({ required this.chatRoomId,required this.Myname,required this.chattingWithname}) ;
  @override
