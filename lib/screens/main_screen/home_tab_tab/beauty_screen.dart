...
final items = [
  "https://media.istockphoto.com/vectors/fashion-banner-vector-id656739876",
  "https://thumbs.dreamstime.com/z/banner-modern-fashion-accessories-young-women-shoes-handbag-phone-gadget-lipstick-cosmetics-bouquet-flowers-pink-background-banner-126365679.jpg",
  "https://c8.alamy.com/comp/FA8YB2/fashion-banner-with-business-lady-accessories-feminine-objects-over-FA8YB2.jpg",
  "https://image.freepik.com/free-vector/fashion-banner-with-accessories-outfit_83728-1881.jpg",
];
...
//
      if (_scrollController.position.pixels ==
        ...
        context.read<ProductBloc>().add(ProductGetMoreDataByCategoryCodeEvent(filter: "", catId: 324));
      }
    });
  }
