...
final items = [
"https://img.freepik.com/free-vector/fashion-sale-banners-with-photo_52683-9828.jpg?size=626&ext=jpg",
  "https://i.pinimg.com/originals/43/74/68/43746878ed1794b1171c74c5e0055819.jpg",
  "https://i.pinimg.com/originals/50/b3/13/50b313b1d56bdb18c175f0dfe23ade81.jpg",
  "https://img.freepik.com/free-vector/promotion-fashion-banner_1188-161.jpg?size=626&ext=jpg",
];
...
//
      if (_scrollController.position.pixels ==
        ...
        context.read<ProductBloc>().add(ProductGetMoreDataByCategoryCodeEvent(filter: "", catId: 17));
      }
    });
  }
