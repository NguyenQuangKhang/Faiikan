...
import 'package:faiikan/screens/main_screen/profile_info_screen.dart';
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (_) =>
                            /*context.read<AccountBloc>().userId == 0
                              ? BlocProvider.value(
                          ...
                          )..add(SeenProductEvent(userId: userId.toString())),
                          child: BlocProvider.value(
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (_) => BlocProvider(
                                create: (_) =>
                                    MyRatingBloc(InitialMyRatingState())
                                      ..add(InitiateMyRatingEvent(
